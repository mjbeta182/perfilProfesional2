    ...
    <div class="container-fluid">
        <div class="row" style="width: 100%; position: fixed;z-index: 10;">
            ...
            ${respuesta}
                ...
                <div class="modal fade" id="area" tabindex="-1" role="dialog" aria-labelledby="contactLabel" aria-hidden="true">
            ...
            <div class="row main" style="margin-top: 25px;">
                <div class=" main-tbl">
                    ...
                    <div class="row ">
                        <div class="col-md-10"><input type="text" name="search"  id="buscar" placeholder="Busqueda"></div><div class="col-md-2"> <a id="buttontbl" class="btn btn-primary pull-right" onclick="cargar()"  href="" data-toggle="modal" data-target="#area">Nuevo</a></div>
                    </div>
                    <table class="table active " id="tblMostrar" >
                        ...
                        <tr>
                            ...
                            <td id="colAccion" style="width: 50px;">
                                <a   class="btn btn-primary" id="button" href="" data-toggle="modal" data-target="#area" onclick="cargar(<%= a.getIdArea()%>, '<%=a.getNombreArea()%>')" ><span class="glyphicon glyphicon-plus-sign"></span></a>
                            </td>
                        </tr>
                        <% }%>
                    </table>
