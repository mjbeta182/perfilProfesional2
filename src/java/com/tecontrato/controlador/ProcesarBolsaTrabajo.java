...
import com.tecontrato.modelo.BolsaTrabajo;
import com.tecontrato.modelo.CrudBolsaTrabajo;
 ...
 */
public class ProcesarBolsaTrabajo extends HttpServlet {
 protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CrudBolsaTrabajo crbt = new CrudBolsaTrabajo();
        String respuesta = null;
        
        try {
            
            bt.setCurriculum(new Curriculum(Integer.parseInt(request.getParameter("txtIdCurriculum"))));
            bt.setEmpresa(new Empresa(Integer.parseInt(request.getParameter("txtIdEmpresa"))));
            
            if(request.getParameter("btnGuardar")!=null)
            {
                crbt.insertarBolsaTrabajo(bt);
