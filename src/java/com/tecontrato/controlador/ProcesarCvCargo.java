...
import com.tecontrato.modelo.CrudCvCargo;
import com.tecontrato.modelo.Curriculum;
import com.tecontrato.modelo.CvCargo;
 ...
 */
public class ProcesarCvCargo extends HttpServlet {
 ...
 protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CvCargo cc = new CvCargo();
        CrudCvCargo crcvca = new CrudCvCargo();
        String respuesta = null;
        
        try {
            
            cc.setCurriculum(new Curriculum(Integer.parseInt(request.getParameter("txtIdCurriculum"))));
            cc.setCargo(new Cargo(Integer.parseInt(request.getParameter("txtIdCargo"))));
            if(request.getParameter("btnGuardar")!=null)
            {
                crcvca.insertarCvCargo(cc);
